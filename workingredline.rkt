...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname workingredline) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ())))
;BEATS
(require 2htdp/image)
...
#;(define (line-mover world_state)
  ...
  (define (line-mover world_state)
   (+ 100 (* 40 (modulo (Sounds1-counter (World-Sounds1 world_state)) 16))))

;moves the rectangle to adjust the tempo of the beat
(define (time-adjust world_state)
  (cond [(inrange? 450 500 world_state) 500]
        [else
